...
class Parter(object): #TODO bottom i up nie dziela!(niewyswietla drzwi)
    def __init__(self, wall_width=3, color=(75, 5, 205)):
        ...
        self.korytarz_sali_gimn = ClassRoom(nazwa="korytarz obok sali gimnastycznej", pos=(189,22), room_width=18, room_length=113,
                                            tlo="korytarz_sali_gimn_tlo.jpg")
        ...
        self.szatnia_gimn_dziewczat = ClassRoom(nazwa=u"szatnia gimnastyczna dziewcząt", pos=(207,62), room_width=30, room_length=16,
                                                tlo="szatnia_gimn_tlo.jpg")
        d_rect = self.szatnia_gimn_dziewczat.oblicz_rect_drzwi(door_location='left_wall', door_delta=5, skala=1)
        drzwi_korytarz_sali_gimn_szatnia_gimn_dz = Door(d_rect)
        self.szatnia_gimn_dziewczat.wstaw_drzwi(drzwi_korytarz_sali_gimn_szatnia_gimn_dz, door_location='left_wall')
        self.korytarz_sali_gimn.wstaw_drzwi(drzwi_korytarz_sali_gimn_szatnia_gimn_dz, door_location='right_wall')

        self.szatnia_gimn_chlopcow = ClassRoom(nazwa=u"szatnia gimnastyczna chłopców", pos=(207,78), room_width=30, room_length=17,
                                               tlo="szatnia_gimn_tlo.jpg")
        d_rect = self.szatnia_gimn_chlopcow.oblicz_rect_drzwi(door_location='left_wall', door_delta=5, skala=1)
        drzwi_korytarz_sali_gimn_szatnia_gimn_ch = Door(d_rect)
        self.szatnia_gimn_chlopcow.wstaw_drzwi(drzwi_korytarz_sali_gimn_szatnia_gimn_ch, door_location='left_wall')
        self.korytarz_sali_gimn.wstaw_drzwi(drzwi_korytarz_sali_gimn_szatnia_gimn_ch, door_location='right_wall')

        self.biblioteka = ClassRoom(nazwa="biblioteka", pos=(207,95), room_width=30, room_length=40, tlo="biblioteka_tlo.jpg")
        ...
        self.szatnia_duza = ClassRoom(nazwa=u"duża szatnia", pos=(73,135), room_width=95, room_length=18, tlo="duza_szatnia_tlo.jpg")
        d1_rect = self.szatnia_duza.oblicz_rect_drzwi(door_location='bottom_wall', door_delta=8, skala=1, door_length = 8)
        d2_rect = self.szatnia_duza.oblicz_rect_drzwi(door_location='bottom_wall', door_delta=70, skala=1, door_length = 8)
        ...
        self.korytarz_szatni = ClassRoom(nazwa="korytarz szatni", pos=(73,153), room_width=95, room_length=10, tlo="korytarz_szatni_tlo.jpg")
        d_zewn_rect = self.korytarz_szatni.oblicz_rect_drzwi(door_location='left_wall', door_delta=2, skala=1, door_length = 8)
        d_wewn_rect = self.korytarz_szatni.oblicz_rect_drzwi(door_location='right_wall', door_delta=2, skala=1, door_length = 8)
        ...
        self.szatnia_mala = ClassRoom(nazwa=u"mała szatnia", pos=(73,163), room_width=46, room_length=18, tlo="mala_szatnia_tlo.jpg")
        d1_rect = self.szatnia_mala.oblicz_rect_drzwi(door_location='top_wall', door_delta=8, skala=1, door_length = 8)
        d2_rect = self.szatnia_mala.oblicz_rect_drzwi(door_location='top_wall', door_delta=27, skala=1, door_length = 8)
        ...
        self.kantorek_wf = ClassRoom(nazwa="kantorek W-F", pos=(119,163), room_width=49, room_length=18, tlo="kantorek_wf_tlo.jpg")
        d_rect = self.kantorek_wf.oblicz_rect_drzwi(door_location='top_wall', door_delta=1, skala=1, door_length = 8)
        ...
        self.sekretariat = ClassRoom(nazwa="sekretariat", pos=(235,218), room_width=18, room_length=37, tlo="sekretariat_tlo.jpg")
    ...
    def sale(self):
        return [self.sala_gimn,
                ...
                self.sala_23,
                self.szatnia_gimn_dziewczat,
                self.szatnia_gimn_chlopcow,
                self.biblioteka,
                self.szatnia_duza,
