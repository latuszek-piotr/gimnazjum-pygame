...
class Parter(object): #TODO bottom i up nie dziela!(niewyswietla drzwi)
    def __init__(self, wall_width=3, color=(75, 5, 205)):
        ...
        d_rect = self.sala_gimn.oblicz_rect_drzwi(door_location='bottom_wall', door_delta=100, skala=1)
        ...
        d_rect = self.hall_glowny.oblicz_rect_drzwi(door_location='bottom_wall', door_delta=40, skala=1)
        drzwi_zhallu_na_zewnatrz = Door(d_rect)
        self.hall_glowny.wstaw_drzwi(drzwi_zhallu_na_zewnatrz, door_location='bottom_wall')
        self.hall_glowny.wstaw_drzwi(drzwi_sala_gimn_hall, door_location='top_wall')
        self.hall_glowny.wstaw_drzwi(drzwi_korytarz_sali_gimn_hall, door_location='top_wall')
        self.hall_glowny.wstaw_drzwi(drzwi_korytarz_szatni_hall, door_location='left_wall')
        ...
        self.osiem = ClassRoom(nazwa="sala 8", pos=(40,181), room_width=46, room_length=37)
        ...
        d_rect = self.lazienka_meska.oblicz_rect_drzwi(door_location='bottom_wall', door_delta=15, skala=1)
        ...
        self.korytarz_parteru.wstaw_drzwi(drzwi_osiem_korytarz_parteru, door_location='left_wall')
        self.korytarz_parteru.wstaw_drzwi(drzwi_siodemka_korytarz_parteru, door_location='bottom_wall')
        self.korytarz_parteru.wstaw_drzwi(drzwi_szostka_korytarz_parteru, door_location='bottom_wall')
        ...
        self.hall_glowny.wstaw_drzwi(drzwi_stolowka_hall, door_location='right_wall')
        ...
        self.hall_glowny.wstaw_drzwi(drzwi_sekretariat_hall, door_location='right_wall')
